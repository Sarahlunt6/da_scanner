      ...
      <div className="max-w-2xl w-full">
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-green-200 text-center">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">
            Your Digital Authority Scan is Complete!
          </h1>
          ...
          <div className="text-left space-y-4 mb-8">
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700">Your overall <strong>Digital Authority Score</strong> (0-100)</p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700"><strong>TAPS Framework breakdown</strong> across all 3 phases</p>
            </div>
          ...
          <div className="pt-6 border-t border-gray-200">
            <p className="text-gray-600 text-sm">
              ...
              <a href="mailto:support@opkie.com" className="text-primary hover:underline font-semibold">
                contact us
              </a>
            </p>
          </div>
